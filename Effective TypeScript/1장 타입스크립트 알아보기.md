...
JavaScript는 인터프리터 언어로 컴파일 되지 않는다. (다만 TS가 JS로 컴파일 될 뿐.) <br/>
...
성능을 최적화하기 위해 많은 현대적인 JavaScript 엔진은 Just-In-Time (JIT) 컴파일 기술을 사용. <br/>
이 과정에서 일부 JavaScript 코드는 기계어로 변환될 여지 존재. <br/>
